package citrus.input.controllers {
	...
	import citrus.input.input.InputController;
	...
	public class KeyboardController extends InputController
	{
		...
		public function KeyboardController(stage:Stage,_input:Input,name:String, params:Object = null)
		{
			super(_input,name, params);
			this.stage = stage;
			input = _input;
