...
package rawui
{
	...
	public class UI_MixPanel extends GComponent
	{
		...
		public var m_maxLevelGroupCtrl:Controller;
		...
		public var m_toAttr:UI_Button;
		public var m_saveStuff:UI_Button;
		...
		protected override function constructFromXML(xml:XML):void
		{
			...
			m_maxLevelGroupCtrl = this.getControllerAt(3);
			...
			m_hasLevel = GButton(this.getChildAt(34));
			...
			m_toAttr = UI_Button(this.getChildAt(44));
			m_saveStuff = UI_Button(this.getChildAt(45));
		}
	}
}